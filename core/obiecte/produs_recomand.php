...
{
  $this->html = "\n\n".'<div class="w-product-item transition-3 mb-25 swiper-slide">
  <div class="w-product-thumb p-relative fix m-img"><a href="'.$this->link_url.'">';
  $this->html.= $this->images.'</a><div class="w-product-badge">';
  $this->html.= $this->stickers;  
  $this->html.= '</div></div>';
  $this->html.= '<div class="w-product-content"><div class="w-product-category">';
  $this->html.= $this->categs;
  $this->html.= '</div><h3 class="w-product-title" title="'.h($this->produs['produsul']).'"><a href="'.$this->link_url.'">';
  $this->html.= trim($this->produs['produsul']).'</a></h3>';
  $this->html.= '<div class="w-product-rating d-flex align-items-center"><div class="w-product-rating-icon">';
  $this->html.= '<span><i class="fa-solid fa-star"></i></span><span><i class="fa-solid fa-star"></i></span>
  <span><i class="fa-solid fa-star"></i></span><span><i class="fa-solid fa-star"></i></span>
  <span><i class="fa-solid fa-star-half-stroke"></i></span></div>';
  $this->html.= '<div class="w-product-rating-text"><span>(2 Reviews)</span></div>';
  $this->html.= '</div><div class="w-product-price-wrapper">';
