...
<div id="header-sticky-2" class="w-header-sticky-area">
<div class="container">
   <div class="w-mega-menu-wrapper p-relative">
      <div class="row align-items-center">

         <div class="col-xl-3 col-lg-3 col-md-3 col-6">
            <div class="logo"><a href="./"><img src="assets/images/logo.svg" alt="Logo"></a></div>
         </div>

         <div class="col-xl-8 col-lg-8 col-md-8 d-none d-md-block">
            <div class="w-header-sticky-menu main-menu menu-style-1">
               <nav id="mobile-menu">{$xTopMeniu}</nav>
            </div>
         </div>

         <div class="col-xl-1 col-lg-1 col-md-2 col-6">
            <div class="w-header-action d-flex align-items-center justify-content-end ml-50">


               <!-- <div class="w-header-orders d-none d-lg-block me-4 ms-1">
                <a href="tel:{$ws_config.head_phone_orders}" class="d-flex align-items-center">
                <div class="w-header-orders-icon">
                    <span>
                ...
                <div class="w-header-orders-content d-none d-xl-block">
                    <span>{$ws_config.head_phone_label}</span>
                    <h6>{$ws_config.head_phone_orders}</h6>
                </div>
                </a>
               </div> -->

               <a href="contul-meu/favorite/" class="w-header-action-btn hide-mobile" title="Produse FAVORITE">
                  ...
                  <span class="w-header-action-badge">1</span>                          
               </a>
