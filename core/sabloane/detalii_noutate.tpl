...
<div class="col-12">
     ...
     <h3 class="w-postbox-details-title text-center">{$xNoutate.art_title}</h3>
     <div class="w-postbox-details-meta text-center mb-50">
        <span><i class="fa-solid fa-calendar me-2"></i>{$xNoutate.data_pub}</span>
        <span><i class="fa-solid fa-eye me-2 ms-3"></i>{$xNoutate.accesari} accesari</span>
     </div></div>
     <div class="w-postbox-details-thumb">
        <img src="{$xNoutate.imaginea}" class="img-fluid border rounded" alt="">
     </div>        
    </div>
