...
{else}
   <div class="col-xl-9 col-lg-8 mx-auto text-center">
    <div class="w-contact-wrapper">
    <h3 class="w-contact-title text-center text-lg-start">Inregistrare cont nou client</h3>
    ...
    <div class="row mb-2">
      <div class="col-xl-4 col-lg-4 mb-4">
        ...
        <div class="w-contact-input">
          <select name="tip_client" id="tip_client" class="nice-select py-3 w-100 fw-bold" required  style="height: 55px;">
            <option value="PF">Persoana Fizica</option>
            <option value="PJ">Persoana Juridica</option>
          </select>
        </div>
        <div class="w-contact-input-title">
          <label for="tip_client" class="color3-tema">Tip client</label>
        </div>
        </div>
      </div>    
    ...
    <div class="row mb-2">
      ...
      <div class="col-xl-6 col-lg-6 mb-4">
        <div class="w-contact-input-box">
        <div class="w-login-input">
          <input id="parola" name="parola"  type="password" class="fw-bold" required minlength="6" placeholder="Parola cont ...">
        </div>
        <div class="w-login-input-eye" id="password-show-toggle">
        ...
        <div class="w-contact-input-title">
          <label for="parola" class="color3-tema">Parola cont</label>
        </div>
        </div>
      </div>  
      </div>   
  ...
  <div class="row mb-2">
      <div class="col-xl-4 col-lg-4 mb-4">
        <div class="w-contact-input-box">
        <div class="w-contact-input">
          <input name="telefon1" id="telefon1" type="text" class="fw-bold" required minlength="5" placeholder="Nr.Telefon 1...">
        </div>
        <div class="w-contact-input-title">
          <label for="telefon1" class="color3-tema">Nr. de Telefon 1</label>
        </div>
        </div>
      </div>
      <div class="col-xl-4 col-lg-4 mb-4">
        <div class="w-contact-input-box">
        <div class="w-contact-input">
          <input name="telefon2" id="telefon2" type="text" class="fw-bold" placeholder="Nr.Telefon 2...">
        </div>
        <div class="w-contact-input-title">
          <label for="telefon2" class="color3-tema">Nr. de Telefon 2 (Optional)</label>
        </div>
        </div>
      </div>
      <div class="col-xl-4 col-lg-4 mb-4">
        <div class="w-contact-input-box">
        <div class="w-contact-input">
          <input name="fax" id="fax" type="text" class="fw-bold" placeholder="Nr.Fax ...">
        </div>
        <div class="w-contact-input-title">
          <label for="fax" class="color3-tema">Nr. Fax (Optional)</label>
        </div>
        </div>
      </div>      
      </div>
    ...
    <div class="row mb-2">      
      <div class="col-xl-4 col-lg-4 mb-4">
        <div class="w-contact-input-box">
        <div class="w-contact-input">
          <input name="loc_judet" id="loc_judet" type="text" class="fw-bold" required minlength="2" placeholder="Localitate / Judet ...">
        </div>
        <div class="w-contact-input-title">
      ...
      <div class="col-xl-4 col-lg-4 mb-4">
        <div class="w-contact-input-box">
        <div class="w-contact-input">
          <input name="cod_postal" id="cod_postal" type="text" class="fw-bold" required minlength="3" placeholder="Codul Postal ...">
        </div>
        <div class="w-contact-input-title">
          <label for="cod_postal" class="color3-tema">Codul Postal</label>
        </div>
        </div>
      </div>  
      <div class="col-xl-4 col-lg-4 mb-4">
        ...
        <div class="w-contact-input">
          <select name="mod_plata" id="mod_plata" class="nice-select py-3 w-100 fw-bold" required  style="height: 55px;">
            ...
            <option value="CARD">PLATA ONLINE</option>
          </select>
        </div>
        <div class="w-contact-input-title">
  ...
  <div class="row mb-2">
    <div class="col-xl-12 col-lg-12 mb-4">
        <div class="w-contact-input-box">
        <div class="w-contact-input">
          <input name="adresa_client" id="adresa_client" type="text" class="fw-bold" required minlength="4" placeholder="Adresa clientului ...">
        </div>
        <div class="w-contact-input-title">
          <label for="adresa_client" class="color3-tema">Adresa de domiciliu client</label>
        </div>
        </div>
      </div>
    </div>
    ...
    <div class="row mb-2">
      <div class="col-xl-6 col-lg-6 mb-4">
        <div class="w-contact-input-box">
        <div class="w-contact-input">
          <input name="compania" id="compania" type="text" class="fw-bold" placeholder="Denumirea companiei ...">
        </div>
        <div class="w-contact-input-title">
          <label for="compania" class="color3-tema">Denumirea companiei</label>
        </div>
        </div>
      </div>
      <div class="col-xl-3 col-lg-3 mb-4">
        <div class="w-contact-input-box">
        <div class="w-contact-input">
          <input name="cod_fiscal" id="cod_fiscal" type="text" class="fw-bold" placeholder="Codul Fiscal ...">
        </div>
        <div class="w-contact-input-title">
          <label for="cod_fiscal" class="color3-tema">Codul Fiscal</label>
        </div>
        </div>
      </div> 
      <div class="col-xl-3 col-lg-3 mb-4">
        <div class="w-contact-input-box">
        <div class="w-contact-input">
          <input name="nr_reg_com" id="nr_reg_com" type="text" class="fw-bold" placeholder="Nr.Inreg.Reg.Com ...">
        </div>
        <div class="w-contact-input-title">
          <label for="nr_reg_com" class="color3-tema">Nr.Inreg.Reg.Com</label>
        </div>
        </div>
      </div>      
    </div>
    ...
    <div class="row mb-2">
      <div class="col-xl-6 col-lg-6 mb-4">
        <div class="w-contact-input-box">
        <div class="w-contact-input">
          <textarea name="adresa_livrare" id="adresa_livrare" class="fw-bold" placeholder="Adresa de Livrare ..."></textarea>
        </div>
        <div class="w-contact-input-title">
      ...
      <div class="col-xl-6 col-lg-6 mb-4">
        <div class="w-contact-input-box">
        <div class="w-contact-input">
          <textarea name="adresa_facturare" id="adresa_facturare" class="fw-bold" placeholder="Adresa de Facturare ..."></textarea>
        </div>
        <div class="w-contact-input-title">
    ...
    <div class="col-xl-4 col-lg-4 mb-3">  
      <div class="w-contact-btn w-100">
        <button type="submit" class="w-100">Inregistrare cont</button>
      </div>
    </div>
    </div>
