      ...
      <div class="profile__tab mr-40">
        <nav>
            <div class="nav nav-tabs w-tab-menu flex-column" id="profile-tab" role="tablist">
              <a class="nav-link active" href="contul-meu/"><span><i class="fa-regular fa-id-card"></i></span> Contul Meu</a>
                  ...
                  <div class="row align-items-center">
                     <div class="col-md-6">
                        <div class="profile__main-inner d-flex flex-wrap align-items-center">
                           ...
                           <div class="profile__main-content">
                              <h4 class="profile__main-title">{$CLIENT_NAME}</h4>
                              <span>marinela.paun@gmail.com</span>
                     ...
                     <div class="col-md-6">
                        <div class="profile__main-logout text-sm-end">
                           <a href="login.html" class="w-logout-btn">Logout</a>
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="col-md-6 col-sm-6">
                        <div class="profile__main-info-item">
                           <div class="profile__main-info-icon">
                              <span>
                                 <span class="profile-icon-count profile-order">4</span>
                           ...
                           <h4 class="profile__main-info-title">Comenzile Mele</h4>
                        </div>
                     </div>
                     <div class="col-md-6 col-sm-6">
                        <div class="profile__main-info-item">
                           <div class="profile__main-info-icon">
                              <span>
                                 <span class="profile-icon-count profile-wishlist">4</span>
                           ...
                           <h4 class="profile__main-info-title">Produse Favorite</h4>
                        </div>
                     </div>
