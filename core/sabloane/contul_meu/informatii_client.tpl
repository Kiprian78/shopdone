      ...
      <div class="profile__tab mr-40">
        <nav>
            <div class="nav nav-tabs w-tab-menu flex-column" id="profile-tab" role="tablist">
              ...
              <a class="nav-link active" href="contul-meu/informatii/"><span><i class="fa-regular fa-user-pen"></i></span> Date personale</a>
      ...
      <div class="tab-content" id="profile-tabContent">
         ...
         <div class="tab-pane fade show active" id="nav-information" role="tabpanel" aria-labelledby="nav-information-tab">
            <div class="profile__info">
               <h3 class="profile__info-title">Date personale</h3>
