...
{else}
   <div class="col-xl-6 col-lg-6 mx-auto text-center">
    <div class="w-contact-wrapper">
    <h3 class="w-contact-title text-center">Autentificare client</h3>
    ...
    <div class="col-xl-12 col-lg-12 mb-3">  
      <div class="w-contact-btn w-100">
        <button type="submit" class="w-100">Autentificare cont</button>
      </div>
    </div>
      <div class="col-xl-12 col-lg-12 mb-4">
        <div class="w-contact-text-box">
          <span>Recuperare parola<span> &nbsp;&gt;&nbsp; <a href="recovery/"><strong>Am uitat parola !</strong></a>
        </div>
     </div>    
    </div>
