...
<section class="w-subscribe-area pt-40 pb-45 theme-bg p-relative z-index-1">
<div class="w-subscribe-plane">
   <img class="w-subscribe-plane-shape" src="assets/img/subscribe/plane.png" alt="">
...
<div class="row align-items-center">
   <div class="col-xl-7 col-lg-7">
      <div class="w-subscribe-content">
         <span>Pentru ofertele noastre</span>
         <h3 class="w-subscribe-title">Abonare la Newsletter</h3>
      </div>
   </div>
   <div class="col-xl-5 col-lg-5">
      <div class="w-subscribe-form">
         <form action="#">
            <div class="w-subscribe-input">
               <input type="email" id="anl_email" name="anl_email" required minlength="6" placeholder="Adresa dvs de email ...">
               <button type="button" onclick="AbonareNL();">Abonare</button>
            </div>
         </form>
      </div>
   </div>
