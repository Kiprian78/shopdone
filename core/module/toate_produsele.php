<?php
/***************************************************************/
$incTPL = 'toate_produsele.tpl';
/***************************************************************/
$selTM = $pag->getTM(27);
$pag->SEO($selTM['seo_page_title'],$selTM['seo_meta_keys'],$selTM['seo_meta_desc']);
/***************************************************************/
$bc = new Breadcrumb(h($selTM['meniul']));
$catalog_url = 'toate-produsele/';
/***************************************************************/
$bc->addItem(h($selTM['seo_page_title']));
$bc->getHTML();
/***************************************************************/
/** SORTAREA LISTARII TUTUROR PRODUSELOR */
/***************************************************************/
...
/***************************************************************/
$sql = "SELECT * FROM produse WHERE activ >= 1 ";
